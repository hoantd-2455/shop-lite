      ...
      {items.length === 0 ? (
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_18rem]">
          ...
          <aside className="h-fit rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <button
              className="mt-5 w-full rounded-lg bg-blue-600 px-4 py-2.5 font-semibold text-white transition hover:bg-blue-700"
              onClick={() =>
                window.alert(
                  "Chức năng thanh toán sẽ được triển khai ở module Next.",
                )
              }
              type="button"
            >
            ...
            <button
              className="mt-3 w-full rounded-lg border border-red-200 px-4 py-2.5 font-semibold text-red-700 transition hover:bg-red-50"
              onClick={clearCart}
              type="button"
            >
